{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 249.0, 44.0, 895.0, 568.0 ],
		"bglocked" : 0,
		"defrect" : [ 249.0, 44.0, 895.0, 568.0 ],
...
, 			{
				"box" : 				{
					...
					"hltcolor" : [ 0.905882, 0.905882, 0.905882, 1.0 ],
					"id" : "obj-4",
					"items" : [ "IAC Driver IAC Bus 1", ",", "IAC Driver IAC Bus 2", ",", "IAC Driver IAC Bus 3", ",", "IAC Driver IAC Bus 4", ",", "IAC Driver IAC Bus 5", ",", "to MaxMSP 1", ",", "to MaxMSP 2", ",", "from ArduinomeSerial 1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 109.0, 57.0, 17.0 ],
									"text" : "loadmess 3"
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 667.0, 207.0, 773.0, 807.0 ],
						"bglocked" : 0,
						"defrect" : [ 667.0, 207.0, 773.0, 807.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 190.0, 110.0, 60.0, 17.0 ],
									"text" : "r 64sync-out"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-35", 0 ],
									"hidden" : 0,
									"midpoints" : [ 199.5, 128.5, 173.5, 128.5 ],
									"source" : [ "obj-38", 0 ]
								}
