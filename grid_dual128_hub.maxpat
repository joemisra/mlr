{
	"patcher": {
		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 12.0, 200.0, 95.0, 22.0 ],
					"text": "r box/press_a"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 12.0, 234.0, 95.0, 22.0 ],
					"text": "r box/press_b"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 130.0, 216.0, 145.0, 22.0 ],
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [ 130.0, 268.0, 105.0, 22.0 ],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 300.0, 234.0, 65.0, 22.0 ],
					"text": "dual128 0"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 380.0, 268.0, 65.0, 22.0 ],
					"text": "dual128 0"
				}
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [ 300.0, 308.0, 105.0, 22.0 ],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [ "" ],
					"patching_rect": [ 380.0, 234.0, 67.0, 22.0 ],
					"text": "edition 256"
				}
			}
		],
		"lines": [
			...
			{
				"patchline": {
					"destination": [ "obj-merge", 1 ],
					"source": [ "obj-rb", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-smlr", 0 ],
					"source": [ "obj-merge", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-lm0", 0 ],
					"source": [ "obj-lb", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-merge", 0 ],
					"midpoints": [ 309.5, 262.0, 285.0, 262.0, 285.0, 205.0, 139.5, 205.0 ],
					"source": [ "obj-lm0", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-smat", 0 ],
					"source": [ "obj-lm0", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-merge", 0 ],
					"midpoints": [ 309.5, 295.0, 285.0, 295.0, 285.0, 205.0, 139.5, 205.0 ],
					"source": [ "obj-msg-on", 0 ]
				}
			},
			{
				"patchline": {
					"destination": [ "obj-merge", 0 ],
					"midpoints": [ 389.5, 295.0, 285.0, 295.0, 285.0, 205.0, 139.5, 205.0 ],
